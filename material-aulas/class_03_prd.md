...
* **Critérios de Aceite**:
  ...
  * Ao receber uma nova solicitação de empréstimo (contendo valor principal, `clienteId`, **quantidade de parcelas** e tipo de amortização), a aplicação deve consultar a API externa de análise de crédito.
